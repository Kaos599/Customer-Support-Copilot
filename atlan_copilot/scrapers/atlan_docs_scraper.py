...
class AtlanDocsScraper(BaseScraper):
    """
    A scraper specifically for the Atlan documentation site (docs.atlan.com).
    """
    def __init__(self):
        super().__init__("https://docs.atlan.com")

    def scrape(self, max_pages: int = 50) -> List[Dict[str, str]]:
        """
        Crawls the Atlan documentation site starting from the base URL.

        Args:
            max_pages: The maximum number of pages to scrape to prevent getting stuck.
        ...
        while urls_to_visit and len(pages_content) < max_pages:
            ...
            # --- Site-specific Logic ---
            # Extract main content. A common pattern for documentation sites is a <main> or <article> tag.
            ...
            if main_content:
                ...
                for link in main_content.find_all("a", href=True):
                    ...
                    # Validate the link before adding to the queue
